...
### scan.tsv
This format is generated by the scan and fastq modes and contains detailed level of transcriptomic features.<br>
| Sequence | Matched_location | Matched_mutations | Matched_strand  | Matched_peptide | Matched_nucleotide | Matched_reference_nucleotide | Matched_read_count | Matched_RPHM | Proportion |
| :---:    | :---:            | :---:             | :---:           | :---:           | :---:              | :---:                        | :---:              | :---:        | :---:      |

| Column                            | Description                                                                       | Example           |  Scan mode   | FASTQ mode |
| :---:                             | :---:                                                                             | :---:             | :---:        | :---:      |
| Sequence                          | Input peptide sequence                                                            |                   |  Y           | Y          |
| Matched_location                  | Matched genomic location                                                          |                   |  Y           | N          |
| Matched_mutations                 | Nucleotide variants including SNV and INDEL                                       |                   |  Y           | N          |
| Matched_strand                    | RNA strand                                                                        |                   |  Y           | N          |
| Matched_peptide                   | Translated nucleotide sequence directly from the input NGS                        |                   |  Y           | Y          |
| Matched_nucleotide                | Nucleotide sequence directly from the input NGS                                   |                   |  Y           | Y          |
| Matched_reference_nucleotide      | Reference nucleotide sequence of a given genomic region                           |                   |  Y           | N          |
| Matched_read_count                | The number of reads supporting the match                                          |                   |  Y           | Y          |
| Matched_RPHM                      | Normalized read count supporting tha match                                        |                   |  Y           | Y          |
| Proportion                        | Proportion of this annotation among all reads matching the input peptide sequence |                   |  Y           | Y          |

### target.tsv
This format is generated by the target mode.<br>

### gloc.tsv
This format is generated by the scan mode.<br>

### peptide.tsv
This format is generated by the scan mode.<br>

### annotate.tsv
This format is generated by the annotate mode.<br>
